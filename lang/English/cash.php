...
$cs_lang['addaccount']          = 'Manage data';
$cs_lang['number']              = 'Account number:';
$cs_lang['owner']               = 'Account holder:';
$cs_lang['bcn']                 = 'Bank code:';
$cs_lang['bank']                = 'Name of the bank:';
$cs_lang['optional']            = 'Optional Data:';
$cs_lang['iban']                = 'IBAN-Number:';
$cs_lang['bic']                 = 'BIC-Number:';
$cs_lang['no_owner']            = '- No account holder given';
$cs_lang['no_number']           = '- No account number given';
$cs_lang['no_bcn']              = '- No bank code given';
$cs_lang['no_bank']             = '- No bank given';
$cs_lang['nonumber']            = 'No bank account data given';
