...
$cs_lang['error_count'] = 'You forgot to fill in all required fields.';
$cs_lang['new_award'] = 'New Award';
$cs_lang['event'] = 'Event';
$cs_lang['place'] = 'Rank';
$cs_lang['game'] = 'Game';
$cs_lang['info'] = 'Information';
$cs_lang['game_create'] = 'New';
$cs_lang['edit_done'] = 'Successfully changed';
$cs_lang['all'] = 'Currently are %s Award(s) inscribed';
$cs_lang['event_url'] = 'Homepage';
$cs_lang['no_date'] = '- A date is required';
$cs_lang['no_event'] = '- A event is required';
