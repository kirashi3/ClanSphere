...
$cs_lang['filename'] = 'Filename';
$cs_lang['size'] = 'Filesize';
$cs_lang['downloaded'] = 'Downloaded';
$cs_lang['delatt'] = 'Remove Attachment';
...
//com_remove.php
$cs_lang['head_com_remove']    = 'Remove Reply';
$cs_lang['com_remove_errortext'] = 'The answer you want to delete does not exist or you dont have the rights to delete it.';
...
//nav_list.php
$cs_lang['no_new_posts']    = 'No new posts';

//listabo.php
$cs_lang['created_by'] = 'Created by';
$cs_lang['abos'] = 'Subscriptions'; 
...
$cs_lang['fill_out_all_fields'] =  'Please fill in all fields with *';
$cs_lang['report_success'] = 'Created successful';
$cs_lang['report_exists'] = 'Entry is still existing.';
$cs_lang['report_errortext'] = 'You can\'t report without enough access.';

// reportlist.php
$cs_lang['reportlist'] = 'Reportlist';
$cs_lang['done'] = 'Done';

// reportdel.php
$cs_lang['reportdel'] = 'Remove report';
$cs_lang['remove_rly'] = 'Really delete dataset No. %s ?';

// reportdone.php
$cs_lang['reportdone'] = 'Conclude report';
$cs_lang['done_true'] = 'Dataset saved as done.';
...
$cs_lang['del_abo'] = 'Unsubscribe';
$cs_lang['abo_done'] = 'Thread successfully subscribed.';
$cs_lang['abo_del_done'] = 'Subscription unsubscribed';
...
$cs_lang['thread_delpin'] = 'Unpin thread';
$cs_lang['thread_move'] = 'Move thread';
$cs_lang['thread_rename'] = 'Rename thread';

//thread_add.php
$cs_lang['head']    = 'Add thread';
...
// Statistic
$cs_lang['board_stats'] = 'Board statistic';
$cs_lang['threads_and'] = 'Threads:';
$cs_lang['all_users'] = 'Registered user: ';
$cs_lang['stats_newest'] = 'We welcome our newest member: ';
$cs_lang['new_stats_thread'] = 'new threads';
$cs_lang['no_stats_thread'] = 'no new threads';
$cs_lang['pw_stats_thread'] = 'Saved with password';
$cs_lang['user_online'] = 'At the moment %s user and';
$cs_lang['visitor_online'] = ' %s guests online.';
$cs_lang['thread_closed'] = 'Thread closed';
