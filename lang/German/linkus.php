...
$cs_lang['icon'] = 'Banner';
$cs_lang['cur_pic'] = 'Aktueller Banner';

#errors
$cs_lang['no_name'] = '- Es muss ein Name angegeben werden';
$cs_lang['no_url'] = '- Es muss eine URL angegeben werden';
$cs_lang['no_pic'] = '- Es muss ein Bild hochgeladen werden';
...
//list.php
$cs_lang['count_all'] = 'Derzeit sind %s Banner eingetragen.';
